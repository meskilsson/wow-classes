...
export const warriorDefaultAbilities = [
    {
        name: "Basic Attack",
        damageType: "Physical",
        resourceCost: 0,
        isAutoAttack: true,
        usesWeaponSwingTimer: true
    },
    {
        name: "Heroic Strike",
        damageType: "Physical",
...
export class Warrior {
    constructor(stats, name, race, faction, level, exp, expToNextLevel, weapon, offhand, armorSet, accessories, abilities = warriorDefaultAbilities) {
        ...
        this.baseResistances = stats.resistances || { fire: 0, frost: 0, arcane: 0, shadow: 0, nature: 0 };
